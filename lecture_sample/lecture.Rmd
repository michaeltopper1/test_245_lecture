...
Branches have a steep learning curve (as does all of Git), but they are extremely important when working collaboratively. Consider the following workflow which, as you can see, would cause problems:
